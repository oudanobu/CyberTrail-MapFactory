...
export default function TerminalLogs({ selectedTarget, customBbox }: TerminalLogsProps) {
  ...
  const startSimulation = () => {
    ...
    const sliceSequence: SeqEntry[] = [
      ...
      { text: `Target Zoom Levels: ${selectedTarget.layerType === 'world' ? 'Z0 - Z5' : selectedTarget.layerType === 'country' ? 'Z6 - Z8' : selectedTarget.layerType === 'province' ? 'Z9 - Z11' : 'Z12 - Z22'}`, type: 'metric', delay: 3800 },
